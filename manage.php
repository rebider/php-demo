...
<?php
	...
	//include_once('functions/editor_submit.php');
...
/* Control the session auto logout
...
?>
        ...
        <div class="container-xl mt-4">
            ...
            <div class="row">
                <!-- Text editor , refer to https://www.codexworld.com/add-wysiwyg-html-editor-to-textarea-website/ -->
                <!-- status Msg -->
		    ...
		    <div class="mb-3">
			    Title <input type="text" name="title" placeholder="Create the title"><br>
		    </div>
